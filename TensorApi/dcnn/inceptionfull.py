...
path_uid_to_cls = "C:\\Users\\emman\\PycharmProjects\\TensorWebApi\\models\\inception\\imagenet_2012_challenge_label_map_proto.pbtxt"

# File containing the mappings between uid and string. (Downloaded)
path_uid_to_name = "C:\\Users\\emman\\PycharmProjects\\TensorWebApi\\models\\inception\\imagenet_synset_to_human_label_map.txt"

# File containing the TensorFlow graph definition. (Downloaded)
path_graph_def = "C:\\Users\\emman\\PycharmProjects\\TensorWebApi\\models\\inception\\inception_v3.ckpt"


# Image path
test_image_path = "C:\\Users\\emman\\PycharmProjects\\TensorWebApi\\models\\inception\\cropped_panda.jpg"
########################################################################
    ...
    def __init__(self):
        ...
        with self.graph.as_default():
            ...
            with tf.gfile.FastGFile(path_graph_def, 'rb') as file:
                ...
                list = self.graph.get_operations()
                op_invalid_list = ["DecodeJpeg/contents", "DecodeJpeg", "Cast", "ExpandDims/dim", "ExpandDims", "ResizeBilinear/size", "ResizeBilinear", "Sub/y", "Sub", "Mul/y", "Mul"]
                #for op in self.graph.get_operations():
                #    if str(op.name) in op_invalid_list:
                 #       continue
                  #  else:
                   #     list.append(op)
                ...
                for a in to_graph.get_operations():
                    print(str(a.name))
